 ...
 * @author Brian54
 */
public class ListaPacienteFac extends javax.swing.JFrame {

    /**
     * Creates new form ListaPacienteFac
     */
    public ListaPacienteFac() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        TablePacienteFact = new javax.swing.JTable();
        ...
        TablePacienteFact.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID_PACIENTE", "NOMBRE_PACIENTE", "GENERO_PACIENTE", "TIPO_SANGRE_PACIENTE", "ENFERMEDAD_PACIENTE", "FECHA_INGRESO", "NO_HABITACION", "CARGOS_ROOM", "ID_DOCTOR", "NOMBRE_DOCTOR", "DESCARGA_HABITACION", "OBSERVACIONES"
            }
        ) {
        ...
        jPanel1.add(lblCerrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 10, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/fondo.png"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1010, 370));
    ...
    public javax.swing.JTable TablePacienteFact;
